...
const FormSection = ({ navigate, title, subtitle, children, footerText, footerLinkText, onFooterLinkClick }) => (
  <motion.div
    initial={{ opacity: 0, x: -50 }}
    animate={{ opacity: 1, x: 0 }}
    transition={{ duration: 0.6, ease: "easeOut" }}
