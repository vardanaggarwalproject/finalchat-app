...
class NodePgSession extends import_session.PgSession {
  ...
  async transaction(transaction, config) {
    const session = this.client instanceof Pool || NativePool && this.client instanceof NativePool ? new NodePgSession(await this.client.connect(), this.dialect, this.schema, this.options) : this;
