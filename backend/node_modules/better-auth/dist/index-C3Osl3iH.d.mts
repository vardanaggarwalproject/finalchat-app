...
import * as better_call164 from "better-call";
...
declare const magicLink: (options: MagicLinkOptions) => {
  ...
  endpoints: {
     ...
     */
    signInMagicLink: better_call164.StrictEndpoint<"/sign-in/magic-link", {
      method: "POST";
      requireHeaders: true;
      body: z.ZodObject<{
        email: z.ZodEmail;
     ...
     */
    magicLinkVerify: better_call164.StrictEndpoint<"/magic-link/verify", {
      method: "GET";
      query: z.ZodObject<{
        token: z.ZodString;
        callbackURL: z.ZodOptional<z.ZodString>;
      ...
      use: ((inputContext: better_call164.MiddlewareInputContext<better_call164.MiddlewareOptions>) => Promise<void>)[];
      requireHeaders: true;
      metadata: {
        openapi: {
          operationId: string;
