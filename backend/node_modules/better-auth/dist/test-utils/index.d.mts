import { $t as IsSignal, Tt as User, Yt as InferErrorCodes, kt as InferAPI, mt as Auth, nn as InferRoute, wt as Session } from "../index-BZSqJoCN.mjs";
import { h as UnionToIntersection, u as Prettify$1 } from "../helper-BBvhhJRX.mjs";
import "../plugins-DLdyc73z.mjs";
import { p as setCookieToHeader } from "../index-D50id6l_.mjs";
...
declare function getTestInstance<O extends Partial<BetterAuthOptions>, C extends BetterAuthClientOptions>(options?: O | undefined, config?: {
  ...
  client: UnionToIntersection<(C extends undefined ? {} : C) & {
    ...
    $fetch: _better_fetch_fetch80.BetterFetch<{
      plugins: (_better_fetch_fetch80.BetterFetchPlugin | {
        id: string;
        name: string;
        hooks: {
