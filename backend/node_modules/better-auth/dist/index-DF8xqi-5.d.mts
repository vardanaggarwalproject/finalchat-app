...
declare const username: (options?: UsernameOptions | undefined) => {
  id: "username";
  init(ctx: _better_auth_core15.AuthContext): {
    options: {
      databaseHooks: {
        user: {
          create: {
            ...
            } & Record<string, unknown>, context: _better_auth_core15.GenericEndpointContext | null): Promise<{
              data: {
  ...
  endpoints: {
    signInUsername: better_call229.StrictEndpoint<"/sign-in/username", {
      method: "POST";
      body: z.ZodObject<{
    ...
    isUsernameAvailable: better_call229.StrictEndpoint<"/is-username-available", {
      method: "POST";
      body: z.ZodObject<{
        username: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    before: {
      matcher(context: _better_auth_core15.HookEndpointContext): boolean;
